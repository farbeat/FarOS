...
#if CORE == APPS
#define NON_OS_CORE_CONFIG_CONTROL_REG           0xE000ED14 // SCB->CCR
#define NON_OS_CORE_CONFIG_DCACHE_POS            16 // SCB_CCR_DC_Msk
bool non_os_is_dcache_enabled(void)
{
    return ((reg32_getbit(NON_OS_CORE_CONFIG_CONTROL_REG,
                          NON_OS_CORE_CONFIG_DCACHE_POS)) != 0);
}
