...
#else
#define TEST_RTC 2
#define TEST_RTC_IRQ RTC_2_IRQN
#endif
#define MS_PER_S                    1000
#define US_PER_MS                   1000
#define MAX_UINT32                  0xFFFFFFFF
#define US_2_CYCLE ((float)CLOCK_32K_CALI_FREQ / MS_PER_S)
#define CYCLE_2_US ((float)(MS_PER_S * US_PER_MS) / CLOCK_32K_CALI_FREQ)
#define MAX_UINT64                  0xFFFFFFFFFFFFFFFFULL
#define RTC_MAX_MS (MAX_UINT32 / CLOCK_32K_CALI_FREQ * MS_PER_S - 1)
#define RTC_HW_MAX_MS (MAX_UINT32 / CLOCK_32K_CALI_FREQ * MS_PER_S - 1)
#define RTC_1_CYCLE                 1
#define RTC_2_CYCLE                 2
#define TCXO_2_RTC ((float)CLOCK_32K_CALI_FREQ / HAL_TCXO_TICKS_PER_SECOND)
#define RTC_COMPENSAT_1_CYCLE_BY_TCXO       (HAL_TCXO_TICKS_PER_SECOND / CLOCK_32K_CALI_FREQ)
#define RTC_COMPENSAT_2_CYCLE_BY_TCXO       (2 * HAL_TCXO_TICKS_PER_SECOND / CLOCK_32K_CALI_FREQ)
#define RTC_COMPENSAT_3_CYCLE_BY_TCXO       (3 * HAL_TCXO_TICKS_PER_SECOND / CLOCK_32K_CALI_FREQ)
/**
 * @if Eng
