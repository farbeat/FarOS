...
#define MEMATTR0_ADDR     (0xBC0)
#define MEMATTR1_ADDR     (0xBC1)
#define MEMATTR2_ADDR     (0xBC2)
#define MEMATTR3_ADDR     (0xBC3)
#define MEMATTR4_ADDR     (0xBC4)
#define MEMATTR5_ADDR     (0xBC5)
#define MEMATTR6_ADDR     (0xBC6)
#define MEMATTR7_ADDR     (0xBC7)
#define MEMATTR8_ADDR     (0xBC8)
#define MEMATTR9_ADDR     (0xBC9)
#define MEMATTR10_ADDR    (0xBCA)
#define MEMATTR11_ADDR    (0xBCB)
#define MEMATTR12_ADDR    (0xBCC)
#define MEMATTR13_ADDR    (0xBCD)
#define MEMATTR14_ADDR    (0xBCE)
#define MEMATTR15_ADDR    (0xBCF)
...
#define MCLICBASE                   0xFBF
#define CLIC_BASE_REG               read_custom_csr(MCLICBASE)
#define SYS_CLIC_CFG                0
#define sys_clic_intip(x)           (0x1000 + 4 * (x))
#define sys_clic_intie(x)           (0x1001 + 4 * (x))
#define sys_clic_intattr(x)         (0x1002 + 4 * (x))
#define sys_clic_intctl(x)          (0x1003 + 4 * (x))
/**
 * clicintctl[i], reset value: 8'b1111_1111
 */
#define SYS_CLICINTCTL_DEF 0xFF
/**
 * clicintattr[i], reset value: 8'b1100_0000
 */
#define SYS_CLICINTATTR_DEF 0xC1
/**
 * clicintie[i], reset value: 8’b0: i.	[7:1]: ROZ, ii.	[0]: enable bit
 */
#define SYS_CLICINTEN_ENABLE  0x1
#define SYS_CLICINTEN_DISABLE 0x0
/**
 * clicintip[i], reset value: 0 bit[0]: pending bit
 */
#define SYS_CLICINTIP_ENABLE  0x1
#define SYS_CLICINTIP_DISABLE 0x0
#define SYS_CLICFGLEVELBITS   0x4
#define SYS_CLICINTATTR_MODE  0x3
#define SYS_CLICNLBITS        0x4
