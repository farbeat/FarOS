...
extern ipc_send_returns_e send_cmd_with_retval(uint8_t *data, uint32_t length, uint8_t *ret_buf, uint16_t ret_buf_len,
                                               uint16_t *ret_len, resultcb_f result_func);
