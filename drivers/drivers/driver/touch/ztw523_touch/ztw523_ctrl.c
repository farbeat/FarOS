...
static uint8_t g_tp_send_buf[ZTW523_REG_WRITE_LEN] = {0};
static uint8_t g_tp_recv_buf[ZTW523_INPUT_SIZE] = {0};
...
ext_errno tp_i2c_data_read(uint16_t reg_addr, uint8_t *data_buf, uint32_t data_len)
{
    ...
    g_tp_send_buf[ZTW523_I2C_SEND_INDEX0] = reg_addr & 0xff;
    g_tp_send_buf[ZTW523_I2C_SEND_INDEX1] = (reg_addr >> OFFSET_8_BITS) & 0xff;
...
ext_errno tp_i2c_cmd_write(uint16_t cmd)
{
    ...
    g_tp_send_buf[ZTW523_I2C_SEND_INDEX0] = cmd & 0xff;
    g_tp_send_buf[ZTW523_I2C_SEND_INDEX1] = (cmd >> OFFSET_8_BITS) & 0xff;
...
ext_errno tp_i2c_reg_write(uint16_t reg_addr, uint16_t reg_cfg)
{
    ...
    g_tp_send_buf[ZTW523_I2C_SEND_INDEX0] = reg_addr & 0xff;
    g_tp_send_buf[ZTW523_I2C_SEND_INDEX1] = (reg_addr >> OFFSET_8_BITS) & 0xff;
    g_tp_send_buf[ZTW523_I2C_SEND_INDEX2] = reg_cfg & 0xff;
    g_tp_send_buf[ZTW523_I2C_SEND_INDEX3] = (reg_cfg >> OFFSET_8_BITS) & 0xff;
