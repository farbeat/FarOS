...
{
    bool extremum_symbol = (g_adc_regs->rpt_hadc_data_2 & BIT(21)) == BIT(21) ? false : true; // BIT21 is sign bit.
...
/**
 * @brief  ADC trim value config.
 * @param  [in]  adldo_voltage ADLDO base voltage.
 * @param  [in]  adldo_trim ADLDO trim voltage.
 * @param  [in]  simo_trim SIMO trim voltage.
 */
void hal_adc_v152_trim_set(adc_v152_adldo_voltage_t adldo_voltage, uint8_t adldo_trim, uint16_t simo_trim);
