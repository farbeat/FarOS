...
STATIC errcode_t hal_tcxo_v150_init(void)
{
...
STATIC errcode_t hal_tcxo_v150_deinit(void)
{
    hal_tcxo_v150_regs_deinit();
    return ERRCODE_SUCC;
}

STATIC uint64_t hal_tcxo_v150_get(void)
{
...
static hal_tcxo_funcs_t g_hal_tcxo_v150_funcs = {
    .init = hal_tcxo_v150_init,
    .deinit = hal_tcxo_v150_deinit,
    .get = hal_tcxo_v150_get
};

hal_tcxo_funcs_t *hal_tcxo_v150_funcs_get(void)
{
    return &g_hal_tcxo_v150_funcs;
}
