 ...
 */
static inline void hal_spi_v100_ssienr_set_ssi_en(spi_bus_t bus, uint32_t val)
{
    ssienr_data_t ssienr;
    ssienr.d32 = spis_regs(bus)->ssienr;
    ssienr.b.ssi_en = val;
 ...
 */
static inline void hal_spi_v100_ser_set_ser(spi_bus_t bus, uint32_t val)
{
    ser_data_t ser;
    ser.d32 = spis_regs(bus)->ser;
    ser.b.ser = val;
 ...
 */
static inline void hal_spi_v100_baudr_set_sckdv(spi_bus_t bus, uint32_t val)
{
    baudr_data_t baudr;
    baudr.d32 = spis_regs(bus)->baudr;
    baudr.b.sckdv = val;
 ...
 */
static inline void hal_spi_v100_txftlr_set_tft(spi_bus_t bus, uint32_t val)
{
    txftlr_data_t txftlr;
    txftlr.d32 = spis_regs(bus)->txftlr;
    txftlr.b.tft = val;
 ...
 */
static inline void hal_spi_v100_rxftlr_set_rft(spi_bus_t bus, uint32_t val)
{
    rxftlr_data_t rxftlr;
    rxftlr.d32 = spis_regs(bus)->rxftlr;
    rxftlr.b.rft = val;
 ...
 */
static inline uint32_t hal_spi_v100_txflr_get_txtfl(spi_bus_t bus)
{
    txflr_data_t txflr;
 ...
 */
static inline uint32_t hal_spi_v100_rxflr_get_rxtfl(spi_bus_t bus)
{
    rxflr_data_t rxflr;
 ...
 */
static inline uint32_t hal_spi_v100_sr_get_busy(spi_bus_t bus)
{
    sr_data_t sr;
