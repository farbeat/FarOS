 ...
 */
static inline void hal_spi_v151_spi_er_set_start_en(spi_bus_t bus, uint32_t val)
{
    spi_er_data_t spi_er;
    spi_er.d32 = spis_v151_regs(bus)->spi_er;
 ...
 */
static inline void hal_spi_v151_spi_slenr_set_ssef(spi_bus_t bus, uint32_t val)
{
    spi_slenr_data_t spi_slenr;
    spi_slenr.d32 = spis_v151_regs(bus)->spi_slenr;
 ...
 */
static inline void hal_spi_v151_spi_brs_set_frdv(spi_bus_t bus, uint32_t val)
{
    spi_brs_data_t spi_brs;
    spi_brs.d32 = spis_v151_regs(bus)->spi_brs;
    spi_brs.b.frdv = val;
 ...
 */
static inline void hal_spi_v151_spi_twlr_set_twl(spi_bus_t bus, uint32_t val)
{
    spi_twlr_data_t spi_twlr;
    spi_twlr.d32 = spis_v151_regs(bus)->spi_twlr;
    spi_twlr.b.twl = val;
 ...
 */
static inline void hal_spi_v151_spi_rwlr_set_rwl(spi_bus_t bus, uint32_t val)
{
    spi_rwlr_data_t spi_rwlr;
    spi_rwlr.d32 = spis_v151_regs(bus)->spi_rwlr;
    spi_rwlr.b.rwl = val;
 ...
 */
static inline uint32_t hal_spi_v151_spi_tlr_get_tfl(spi_bus_t bus)
{
 ...
 */
static inline uint32_t hal_spi_v151_spi_rlr_get_rfl(spi_bus_t bus)
{
 ...
 */
static inline uint32_t hal_spi_v151_spi_wsr_get_sbf(spi_bus_t bus)
{
 ...
 */
static inline void hal_spi_v151_spi_dcr_set_rden(spi_bus_t bus, uint32_t val)
{
    spi_dcr_data_t spi_dcr;
    spi_dcr.d32 = spis_v151_regs(bus)->spi_dcr;
    spi_dcr.b.rden = val;
 ...
 */
static inline void hal_spi_v151_spi_drdl_data_set_dl(spi_bus_t bus, uint32_t val)
{
    spi_drdl_data_t spi_drdl;
    spi_drdl.d32 = spis_v151_regs(bus)->spi_drdl;
    spi_drdl.b.dl = val;
 ...
 */
static inline uint32_t hal_spi_v151_spi_drnm_data_get_datar(spi_bus_t bus)
{
 ...
 */
static inline void hal_spi_v151_spi_drnm_data_set_datar(spi_bus_t bus, uint32_t val)
{
 ...
 */
static inline void hal_spi_v151_spi_rsdr_data_set_rxdsd(spi_bus_t bus, uint32_t val)
{
    spi_rsdr_data_t spi_rsdr;
    spi_rsdr.d32 = spis_v151_regs(bus)->spi_rsdr;
