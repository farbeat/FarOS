...
/* Heap start address */
#define PSRAM_HEAP_ADDR                     (PSRAM_HM_APP_SYS_ADDR + PSRAM_HM_APP_SYS_LENGTH)
#define PSRAM_HEAP_LENGTH                   psram_align_size(0x5D5800, POOL_ADDR_ALIGNSIZE)

/* plt reserve address */
#define PSRAM_PLT_RESERVE_ADDR              (PSRAM_HEAP_ADDR + PSRAM_HEAP_LENGTH)
#define PSRAM_PLT_RESERVE_LENGTH            psram_align_size(0x0, POOL_ADDR_ALIGNSIZE)

/* GUI memory pool address NON Cache */
#define PSRAM_GUI_MEM_POOL_ADDR             (PSRAM_PLT_RESERVE_ADDR + PSRAM_PLT_RESERVE_LENGTH)
#define PSRAM_GUI_MEM_POOL_SIZE             psram_align_size(0x780000, POOL_ADDR_ALIGNSIZE)
...
#define PSRAM_RESERVE_ADDR_LENGTH           psram_align_size(0x0, POOL_ADDR_ALIGNSIZE)
