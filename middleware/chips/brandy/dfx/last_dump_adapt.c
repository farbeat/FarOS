...
static const diag_reg_dump_t g_reg_dump_info[] = {
...
{
    uint16_t count = (uint16_t)(sizeof(g_reg_dump_info) / sizeof(diag_reg_dump_t));
...
static const diag_mem_dump_t g_mem_dump_info[] = {
    ...
    { "MCPU_L2M_REGION", L2M_DSP_RAM_MCU_SHARE_ORIGIN, L2M_DSP_RAM_MCU_SHARE_LENGTH },
#elif defined(__FREERTOS__)
    { "PSRAM_HEAP", PSRAM_HEAP_ADDR, PSRAM_HEAP_LENGTH },
#endif /* CONFIG_PSRAM_SUPPORT */
#endif /* UNSUPPORT_OTHER_MEM */
};
