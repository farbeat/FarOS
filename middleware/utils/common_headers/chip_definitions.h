...
#define CHIP_FPGA             (CHIP_LIBRA_FPGA || CHIP_SOCMN1_FPGA || CHIP_BS25_FPGA || \
                               CHIP_BRANDY_FPGA || CHIP_BS21_FPGA || CHIP_WS63_FPGA || CHIP_WS53_FPGA)
