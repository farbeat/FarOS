...
#ifdef MEMORY_MINI
#define YAFFS_ALLOCATION_NOBJECTS	25
#define YAFFS_ALLOCATION_NTNODES	25
#define YAFFS_ALLOCATION_NLINKS		25
#else
...
struct yaffs_dir_var {
	dpal_dl_list_t children;  /* list of child links */
	dpal_dl_list_t dirty; /* Entry for list of dirty directories */
};
...
struct yaffs_obj {
	...
	dpal_dl_list_t hash_link;		/* list of objects in hash bucket */

	dpal_dl_list_t hard_links;		/* hard linked object chain*/


	/* directory structure stuff */
	/* also used for linking up the free list */
	struct yaffs_obj *parent;
	dpal_dl_list_t siblings;
...
struct yaffs_dev {
	...
	dpal_dl_list_t dirty_dirs;    /* List of dirty directories */
...
void yaffs_link_fixup(struct yaffs_dev *dev, dpal_dl_list_t *hard_list);
