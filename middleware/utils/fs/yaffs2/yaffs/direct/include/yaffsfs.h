...
#ifdef __OHOS__
int yaffs_chgrp(const YCHAR *path, mode_t mode);
int yaffs_chown(const YCHAR *path, mode_t mode);
#endif
...
struct yaffs_dev;
int yaffs_sync_common(struct yaffs_dev *dev, const YCHAR *path, int do_checkpt);
