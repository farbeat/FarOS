...
if __name__ == '__main__':
    #配置文件路径
    nv_config_json = os.path.join(g_root, "build", "config", "target_config", "brandy", "nv_bin_cfg", "mk_nv_bin_cfg.json")
    #输出路径
    nv_output_path = os.path.join(g_root, "output", "brandy", "nv_bin")
