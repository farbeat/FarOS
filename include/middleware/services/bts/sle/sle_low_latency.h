 ...
 */
typedef enum {
    SLE_LOW_LATENCY_4K = 0, /*!< @if Eng 4000HZ
 ...
 * @endif
 */
typedef errcode_t (*law_latency_key_value_set_callback)(int8_t *button_mask, int16_t *x, int16_t *y, int8_t *wheel);
 ...
 */
typedef struct {
    law_latency_key_value_set_callback set_value_cb;  /*!< @if Eng Discovery structure callback.
                                                           @else 发现服务回调函数。 @endif */
 ...
 * @endif
 */
typedef void(*law_latency_report_callback)(int8_t *data, uint8_t len);
 ...
 */
typedef struct {
    law_latency_report_callback report_cb;  /*!< @if Eng Discovery structure callback.
                                                 @else 发现服务回调函数。 @endif */
