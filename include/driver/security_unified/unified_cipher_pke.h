 ...
 * @param  [in]    p 模数，p->length 只能为 192/224/256/384/512/521/1024/2048/3072/4096bits。
 ...
 * @param  [in]    a 入参，a->length 不能大于 p->length。
 * @param  [in]    b 入参，b->length 不能大于 p->length。
 * @param  [in]    p 模数，p->length 只能为 192/256/384/512/1024/2048/3072/4096bits，且模数不能为偶数。
 * @param  [out]   c 计算结果，c->length 应该与 p->length 相同。
 * @retval ERRCODE_SUCC 成功。
 * @retval Other        失败，参考 @ref errcode_t 。
 * @endif
 ...
 * @param  [in]    n 模数，n->length 只能为 192/256/384/512/1024/2048/3072/4096bits，且模数不能为偶数。
