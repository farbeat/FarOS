...
#if defined(CONFIG_LIBC_LMS_LIBC_HIGH_FREQ_FUNC_CHECK)
...
#if defined(CONFIG_LIBC_KERNEL_LMS) && (!defined(CONFIG_LIBC_LMS_ENABLE_CHECK) || defined(OS_NOT_SUPPORT_SANITIZE_ADDRESS))
