...
#else
#define PTHREAD_STACK_MIN PORT_PTHREAD_STACK_MIN
#endif
 ...
 */
#define SEM_VALUE_MAX PORT_SEM_COUNT_MAX
/**
 * @ingroup semaphore
 * Maximum number of supported semaphores.
 */
#define SEM_NSEMS_MAX KERNEL_SEM_LIMIT
#endif
...
#define _LITEOS_MQ_OPEN_MAX KERNEL_QUEUE_LIMIT
...
#endif
#define RTSIG_MAX 8
#define PTHREAD_ATTR_STACKSIZE KERNEL_TSK_DEFAULT_STACK_SIZE
#define PTHREAD_PRIORITY_SCHEDULING SCHED_OTHER
#define PTHREAD_THREADS_MAX (KERNEL_TSK_LIMIT + 1)

#ifdef CONFIG_LIBC_BASE_CORE_SWTMR
#define TIMERS 1
#else
#define TIMERS 0
#endif
