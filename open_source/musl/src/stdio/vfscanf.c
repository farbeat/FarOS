...
#ifdef __XLT_OS__
static int vfscanf_core(FILE *restrict f, const char *restrict fmt, va_list ap, const struct lockfile_func *l)
#else
...
#ifdef __XLT_OS__
int vfscanf_unlocked(FILE *restrict f, const char *restrict fmt, va_list ap)
{
	return vfscanf_core(f, fmt, ap, (struct lockfile_func *)0);
}
...
int vfscanf(FILE *restrict f, const char *restrict fmt, va_list ap)
{
	...
	return vfscanf_core(f, fmt, ap, &l);
}
