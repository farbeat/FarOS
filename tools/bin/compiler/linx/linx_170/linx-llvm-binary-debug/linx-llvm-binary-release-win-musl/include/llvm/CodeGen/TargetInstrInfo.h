...
public:
  ...
  /// Return true if the cheap move instruction is worth to do Machine
  /// Cse directly.
  ///
  /// Machine Cse would use Heuristics to compute whether certain cheap
  /// move instruction is worth to do Cse or not.
#ifdef BSPUB_RISCV_FEATURE
  virtual bool isProfitCseCheapMove(const MachineInstr &MI) const {
    return false;
  }
#endif
