...
set(LLVM_AUTOGEN_DIR ${CMAKE_CURRENT_SOURCE_DIR})
...
function(tablegen project ofn)
  ...
  if (BSPUB_RISCV_FEATURE)
    list(APPEND tblgen_change_flag "-DBSPUB_RISCV_FEATURE")
  endif()
  ...
  if (LLVM_TARGETS_TO_BUILD MATCHES "RISCV" AND BSPUB_RISCV_FEATURE)
    add_custom_command(OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${ofn}
      COMMAND ${${project}_TABLEGEN_EXE} ${ARGN} -I ${LLVM_AUTOGEN_DIR} -I ${CMAKE_CURRENT_SOURCE_DIR}
      ${tblgen_includes}
      ${LLVM_TABLEGEN_FLAGS}
